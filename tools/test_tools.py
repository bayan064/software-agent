...
def test_run_pyests_python(monkeypatch):
    ...
    result = run_pytest("fake_test.py", language="Python")
...
def test_run_pytest_java(monkeypatch):
    ...
    result = run_pytest("FakeTest.java", language="Java")
